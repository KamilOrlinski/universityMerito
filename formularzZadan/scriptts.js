document.addEventListener('DOMContentLoaded',function(){
    //console.log("test")
        ...
        addSubTaskForm.addEventListener('submit', function(event){
            ...
            //tworzenie i dodawanie podzadań do listy 
    ...
    //funkcja zapisująca stan listy zadań w pamięci lokalnej komputera
    function saveTasks() {
        const tasks = [];
        taskList.querySelectorAll('li').forEach(taskItem => {
            ...
            //iteracja po wszystkich podzadaniach i zapisywanie ich
    ...
    //funkcja odczytująca dane z pamięci lokalnej komputera
    function loadTasks() {
